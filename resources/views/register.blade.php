...
<body class="bg-white flex items-center justify-center min-h-screen">
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 max-w-sm w-full">
        <h2 class="text-green-600 text-center text-2xl font-bold mb-4">Register</h2>
        ...
        <form action="{{ route('register') }}" method="POST">
            ...
            <div class="mb-4">
                <label class="block text-green-700 text-sm font-bold mb-2" for="password_confirmation">Konfirmasi Password</label>
                <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        ...
        <p class="text-center text-gray-600 text-sm mt-4">
            Sudah punya akun? <a href="{{ route('login') }}" class="text-green-500 hover:underline">Login</a>
        </p>
    </div>
</body>
</html>
